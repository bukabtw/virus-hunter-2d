...
def get_level_1():
    platforms = [
        pygame.Rect(0, MAP_HEIGHT - 50, MAP_WIDTH, 4700),
        pygame.Rect(800, MAP_HEIGHT - 150, 300, 30),
        pygame.Rect(1100, MAP_HEIGHT - 150, 300, 30),
        pygame.Rect(1600, MAP_HEIGHT - 250, 300, 30),
        pygame.Rect(1900, MAP_HEIGHT - 250, 300, 30),
        pygame.Rect(2200, MAP_HEIGHT - 350, 300, 30),
        pygame.Rect(2500, MAP_HEIGHT - 350, 300, 30),
        pygame.Rect(2800, MAP_HEIGHT - 450, 300, 30),
        pygame.Rect(3100, MAP_HEIGHT - 450, 300, 30),
        pygame.Rect(3400, MAP_HEIGHT - 550, 300, 30),
        pygame.Rect(3700, MAP_HEIGHT - 550, 300, 30),
        pygame.Rect(4000, MAP_HEIGHT - 650, 300, 30),
        pygame.Rect(4300, MAP_HEIGHT - 650, 300, 30),
    ]
    items = [
        (850, MAP_HEIGHT - 180),
        (1150, MAP_HEIGHT - 180),
